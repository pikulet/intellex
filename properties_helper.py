...
CONTENT_LENGTH, BIGRAM_CONTENT_LENGTH, TRIGRAM_CONTENT_LENGTH, TITLE_LENGTH,  BIGRAM_TITLE_LENGTH, TRIGRAM_TITLE_LENGTH, COURT_PRIORITY, DATE_POSTED, VECTOR_OFFSET= list(range(NUM_DOCUMENT_PROPERTIES))
